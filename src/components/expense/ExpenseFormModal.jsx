...
export default function ExpenseCategoriesFormModal({
  ...
  const categoriesSelectBoxConfig = {
    ...
    getOptionLabel: (option) =>
      defaultNameCheck(t, option.is_default, 'expense_categories.default.', option.name),
    onChange: (e, option) => setChange(option, 'expense_category_id'),
    isOptionEqualToValue: (option, value) => option.id === value.id
  }
          ...
          <form onSubmit={onSubmit}>
              ...
              <div className="row">
                ...
                <div className="col-md-6 mb-3">
                  <SelectBoxField
                    ...
                    isRequired={true}
                    error={error?.expense_category_id}
                    disabled={loading?.ExpenseForm}
                  />
                </div>
                <div className="col-md-6 mb-3">
            ...
            <div className="card-footer text-end">
              <Button
                ...
                loading={loading?.ExpenseForm || false}
                endIcon={<Save size={20} />}
                disabled={Object.keys(error).length || loading?.ExpenseForm}
              />
            </div>
          </form>
        </div>
