  ...
  useEffect(() => {
    ...
    setDetailsSummary([
      ...
      [
        ...
        {
          key: 'total_payable_interest',
          value: tsNumbers(`$${data?.total_payable_interest || 0}/-`),
          icon: <List size={18} />
        },
        {
          key: 'total_payable_loan_with_interest',
          value: tsNumbers(`$${data?.total_payable_loan_with_interest || 0}/-`),
          icon: <List size={18} />
        },
        {
          key: 'deposit',
        ...
        },
        {
          ...
          value: tsNumbers(`$${data?.loan_installment || 0}/-`),
          icon: <List size={18} />
        },
        {
          key: 'interest_installment',
          value: tsNumbers(`$${data?.interest_installment || 0}/-`),
          icon: <List size={18} />
        },
        {
          key: 'total',
