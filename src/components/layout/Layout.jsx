                    ...
                    <div className="row">
                        <div className="col-lg-6 d-none d-lg-block">
                            ...
                            <div className="mt-3">
                                ...
                                <div className="layout-heading-sm mt-3 fs-lg fw-normal text-white text-opacity-70 dark-text-gray-500">Manage all Savings or Loan accounts in one place</div>
                            </div>
                        </div>
